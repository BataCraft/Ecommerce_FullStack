...
export default function UpdateProduct() {
    ...
    const handleImagesChange = (e) => {
      ...
      if (files.length + existingImages.length > MAX_IMAGES) {
        toast.error(`Maximum ${MAX_IMAGES} images allowed in total`);
        return;
      }
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input 
              ...
              hover:file:bg-violet-100"
            />
            <p className="text-xs text-gray-500 mt-1">Maximum 5 images in total, 5MB each</p>
          </div>
          ...
          <Textarea 
            ...
            onChange={(e) => setFormData(prev => ({
              ...
              features: e.target.value.split('\n').filter(feature => feature.trim())
                        ...
                        // Continuing from the Features textarea...
                    ...
                    {/* Metadata (Hidden but included in form data) */}
                    <input 
                      type="hidden" 
                      name="updatedBy" 
                      value="BataCraft"  // Current user
                    />
                    <input 
                      type="hidden" 
                      name="updatedAt" 
                      value="2025-02-10 06:41:15"  // Current UTC timestamp
                    />
